    ...
    <div className="bg-cream/50 p-4 lg:p-6 space-y-4">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-1">
          <p className="text-[10px] text-gold tracking-widest">LIVE CALCULATION RESULT</p>
      ...
      {/* 숨은 비용 알림 */}
      <HiddenCosts costs={output.hiddenCosts} warnings={output.warnings} />
      ...
      <p className="text-[10px] text-gray-300 text-center">
        2025~2026 시장 평균 기반 · 조달청 적산 교차 검증 예정
      </p>
    </div>
  );
}
