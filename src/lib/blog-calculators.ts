...
export const CALCULATORS: Record<CalculatorKey, CalculatorInfo> = {
  ...
  mortar: {
    ...
    mini: "레미탈 포 수·몰탈 비용이 바로 나와요",
    // 2026-09-15: "미장"·"방통"·"레미탈"·"몰탈"·"모르타르"·"셀프레벨링"이 신호 단어.
    // ⚠️ "바닥" 단독·"타일" 단독·"방수" 단독은 절대 넣지 않는다 — 바닥 난방/누수/매트,
    //    타일 자재·방수 공사 글까지 전부 몰탈 계산기가 붙어버리는 오탐이 생긴다
