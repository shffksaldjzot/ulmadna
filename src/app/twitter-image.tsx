  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ fontSize: 72, fontWeight: 900, color: '#5C3A1E', letterSpacing: -2, marginBottom: 12 }}>
            얼마드나
          </div>
          <div style={{ fontSize: 28, color: '#8B7355', marginBottom: 40 }}>
            무료 인테리어 견적 계산기
          </div>
        ...
        <div style={{ marginTop: 32, fontSize: 22, color: '#C9A96E', letterSpacing: 2 }}>
          ulmadna.com
        </div>
      </div>
    ),
