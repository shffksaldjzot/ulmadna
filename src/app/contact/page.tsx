    ...
    <>
      ...
      <Container as="main">
        ...
        <div className="max-w-3xl py-12">
          <h1 className="t-page text-ink mb-2">문의하기</h1>
          <p className="t-body text-ink-2 mb-8">궁금한 점이나 제보가 있으면 편하게 연락 주세요.</p>

          <div className="bg-surface rounded-card p-6 lg:p-8 border border-line space-y-7 t-body text-ink-2 leading-relaxed">
            {/* 대표 문의 메일 */}
            <section>
              <h2 className="t-section text-ink mb-3">이메일 문의</h2>
              <p className="mb-4">
                아래 이메일로 문의를 보내주시면 순차적으로 답변드립니다. 영업일 기준 보통 2~3일 안에 회신드려요.
              </p>
              <a
                href="mailto:cs870@naver.com"
                className="inline-block bg-accent text-white rounded-card px-5 py-3 font-medium hover:opacity-90 transition-opacity"
              >
            ...
            {/* 어떤 문의를 받나 */}
            <section>
              <h2 className="t-section text-ink mb-2">이런 문의를 받아요</h2>
            ...
            {/* 운영 정보 */}
            <section>
              <p className="t-sub text-ink-2 leading-relaxed">
                상호: 얼마드나 · 대표: 김지환<br />
                사업자등록번호: 565-58-00717<br />
                이메일: <a href="mailto:cs870@naver.com" className="text-accent hover:text-ink">cs870@naver.com</a>
              </p>
            </section>

            {/* 관련 링크 */}
            <div className="pt-4 border-t border-line flex flex-wrap gap-x-4 gap-y-2 t-sub">
              <Link href="/about" className="text-accent hover:text-ink">얼마드나 소개</Link>
