...
//
// 2026-09-15 디자인 통일 작업: 페이지 전용 헤더/배경을 걷어내고 공용 틀
// (SiteHeader·Container·SiteFooter)로 교체. 법률·사업자 정보 등 본문 글자는 하나도 바꾸지 않았고,
// 색·글자크기 클래스만 공용 토큰(--ink, --ink-2, --accent 등)으로 맞췄다.
    ...
    <>
      ...
      <Container as="main">
        ...
        <div className="max-w-3xl py-12">
          <h1 className="t-page text-ink mb-2">얼마드나 소개</h1>
          <p className="t-body text-ink-2 mb-8">소비자 편에 선 인테리어 견적 서비스</p>

          <div className="bg-surface rounded-card p-6 lg:p-8 border border-line space-y-7 t-body text-ink-2 leading-relaxed">
            {/* 우리가 누구인가 */}
            <section>
              <h2 className="t-section text-ink mb-2">얼마드나는 어떤 서비스인가요?</h2>
              <p>
            ...
            {/* 왜 만들었나 — 미션 */}
            <section>
              <h2 className="t-section text-ink mb-2">왜 만들었나요?</h2>
              <p>
            ...
            <section>
              <h2 className="t-section text-ink mb-2">견적 금액은 어떤 근거로 나오나요?</h2>
              <p>
            ...
            {/* 무엇을 제공하나 */}
            <section>
              <h2 className="t-section text-ink mb-2">무엇을 제공하나요?</h2>
            ...
            {/* 운영 주체 — 신뢰 정보 */}
            <section>
              <h2 className="t-section text-ink mb-2">운영 정보</h2>
              <p>
                얼마드나는 인테리어 견적 데이터를 다루는 사업자가 직접 운영합니다. 광고(배너·애드센스)와 스폰서 제휴로
                서비스를 무료로 유지하며, 광고는 콘텐츠와 명확히 구분해 표시합니다.
              </p>
              <p className="mt-3 t-sub text-ink-2 leading-relaxed">
                상호: 얼마드나 · 대표: 김지환<br />
                사업자등록번호: 565-58-00717<br />
                문의: <a href="mailto:cs870@naver.com" className="text-accent hover:text-ink">cs870@naver.com</a>
              </p>
            </section>

            {/* 관련 링크 */}
            <div className="pt-4 border-t border-line flex flex-wrap gap-x-4 gap-y-2 t-sub">
              <Link href="/contact" className="text-accent hover:text-ink">문의하기</Link>
              <Link href="/blog" className="text-accent hover:text-ink">블로그</Link>
              <Link href="/privacy" className="text-accent hover:text-ink">개인정보처리방침</Link>
              <Link href="/terms" className="text-accent hover:text-ink">이용약관</Link>
            </div>
          </div>
        </div>
      </Container>
